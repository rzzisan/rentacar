...
export default function AdminDrivers() {
  ...
  const load = useCallback(async () => {
    ...
    const res = await api.get<Driver[]>(`/admin/drivers/index.php?${params}`).catch(() => null);
  ...
  async function loadVehicles() {
    ...
    const res = await api.get<VehicleOption[]>('/vehicles/index.php').catch(() => null);
  ...
  async function handleAdd(fd: FormData) {
    setSaving(true);
    const res = await api.post('/admin/drivers/index.php', fd).catch(() => null);
    if (res?.success) {
      setAddOpen(false);
  ...
  async function handleEdit(fd: FormData) {
    ...
    setSaving(true);
    const res = await api.post(`/admin/drivers/update.php?id=${editDriver.id}`, fd).catch(() => null);
    if (res?.success) {
      setEditDriver(null);
  ...
  async function handleDelete() {
    ...
    setDeleting(true);
    const res = await api.delete(`/admin/drivers/destroy.php?id=${deleteDriver.id}`).catch(() => null);
    if (res?.success) {
