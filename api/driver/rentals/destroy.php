...
// driver শুধু নিজের তৈরি করা pending ট্রিপ ডিলিট করতে পারবে — IDOR প্রতিরোধ
$chk = $conn->prepare("SELECT rental_status FROM rentals WHERE id = ? AND driver_id = ? AND tenant_id = ?");
$chk->bind_param('iii', $id, $driver_id, $tid);
$chk->execute();
